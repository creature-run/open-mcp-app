...
The [`open-mcp-app`](https://www.npmjs.com/package/open-mcp-app) lets you build an MCP App once and run it in Creature, any client that supports MCP Apps, and ChatGPT. Includes server utilities, React hooks, and Vite plugins for seamless development.
