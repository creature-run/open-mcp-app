...
/**
 * MCP Apps host bridge implementation.
 *
 ...
 */
export class McpAppsHostBridge extends McpAppsSubscribable implements HostBridge {
  // ============================================================================
  // Private Properties
  // ============================================================================
  ...
  private setupHandlers(): void {
    ...
    this.app.ontoolresult = (params) => {
      console.log(`[McpAppsHostBridge] ontoolresult called`, {
      ...
      console.log(`[McpAppsHostBridge] Emitting tool-result event`, result);
