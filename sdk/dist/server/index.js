...
function injectHmrClient(html, hmrPort) {
...
function readHmrConfig(basePath) {
  const searchPaths = [
...
function loadHtml(filePath, basePath) {
...
function isSDKPath(filename) {
  return filename.includes("/public/sdk/") || filename.includes("\\public\\sdk\\") || filename.includes("/@creature-ai/sdk/") || filename.includes("\\@creature-ai\\sdk\\");
}
...
function wrapServer(server) {
  ...
  server.registerResource = function(name, uri, metadata, handler) {
